...
int main(int argc, char* argv[]) {
    ...
    auto W1 = load_csv_2d("../../data/weights/dinn30_W1.csv", 784, 30);
    auto b1 = load_csv_1d("../../data/weights/dinn30_b1.csv");
    auto W2 = load_csv_2d("../../data/weights/dinn30_W2.csv", 30, 10);
    auto b2 = load_csv_1d("../../data/weights/dinn30_b2.csv");
