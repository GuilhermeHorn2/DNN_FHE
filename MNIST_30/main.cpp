...
// MNIST-like DiNN30 dimensions (784 -> 30 -> 10).
...
int main(int argc, char* argv[]) {
    ...
    if (argc < 2) {
        std::cerr << "Usage: " << argv[0] << " <image.png>\n"
                  << "  Weights expected at ../dinn30_W{1,2}.csv and ../dinn30_b{1,2}.csv\n";
        return 1;
    }

    std::cout << "Loading weights...\n";
    auto W1 = io::LoadCsv2D("../dinn30_W1.csv", IN_DIM,  HID_DIM);
    auto b1 = io::LoadCsv1D("../dinn30_b1.csv");
    auto W2 = io::LoadCsv2D("../dinn30_W2.csv", HID_DIM, OUT_DIM);
    auto b2 = io::LoadCsv1D("../dinn30_b2.csv");
