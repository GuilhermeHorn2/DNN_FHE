...
// MNIST DiNN: 784 -> HID_DIM -> 10, Heaviside variant.
...
int main(int argc, char* argv[]) {
    ...
    if (argc < 2) {
        ...
        std::cerr << "               Selects ../heaviside<HID>_W{1,2}.csv and ../heaviside<HID>_b{1,2}.csv\n\n";
        std::cerr << "Examples:\n";
    ...
    const std::string prefix = "../heaviside" + std::to_string(HID_DIM);
    ...
    if (fs::is_directory(inputPath)) {
        ...
        // Plain reference: Linear -> Heaviside -> Linear.
